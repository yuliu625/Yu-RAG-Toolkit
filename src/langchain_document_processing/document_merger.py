"""
Sources:
    https://github.com/yuliu625/Yu-RAG-Toolkit/blob/main/src/langchain_document_processor/document_merger.py
...
# 依赖的自构建工具。
from src.langchain_document_processing.content_annotator import ContentAnnotator
from src.langchain_document_processing.content_block_processor import ContentBlockProcessor
